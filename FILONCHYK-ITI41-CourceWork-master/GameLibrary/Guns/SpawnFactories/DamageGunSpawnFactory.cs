...
{
    /// <summary>
    /// Фабрика создания места подбираемого оружия урона
    /// </summary>
    public class DamageGunSpawnFactory : GunSpawnFactory
    {
        /// <summary>
        /// Создание места подбираемого оружия с уроном
        /// </summary>
        ...
        public override GameObject CreateGunSpawn(Vector2 position)
        {
            ...
            gameObject.InitializeObjectComponent(new SpriteComponent(RenderingSystem.LoadBitmap("Resources/MazeElements/Spawn Guns/damage spawn 1.png")));
            ...
            gunSpawn.InitializeGunSpawn("damage", damageGun, 10f);
